...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "OSAMAK — Trouvez un donneur compatible rapidement" },
      { name: "description", content: "OSAMAK met en relation patients en urgence transfusionnelle et donneurs compatibles au Sénégal." },
      { property: "og:title", content: "OSAMAK — Urgences transfusionnelles Sénégal" },
      { property: "og:description", content: "Plateforme numérique de mise en relation entre patients et donneurs de sang compatibles." },
