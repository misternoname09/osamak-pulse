...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "OSAMAK — Urgences transfusionnelles au Sénégal" },
      { name: "twitter:description", content: "Trouvez un donneur de sang compatible en quelques minutes. Solution numérique vitale pour les urgences transfusionnelles au Sénégal." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/dd84682c-768b-45dd-b202-60ad64e26182/id-preview-14c8bbd1--698611c4-8e11-48f8-92e1-8fc8e4a5a38b.lovable.app-1784665932790.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/dd84682c-768b-45dd-b202-60ad64e26182/id-preview-14c8bbd1--698611c4-8e11-48f8-92e1-8fc8e4a5a38b.lovable.app-1784665932790.png" },
    ],
    links: [
